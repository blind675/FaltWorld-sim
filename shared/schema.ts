...
export const terrainCells = pgTable("terrain_cells", {
  ...
  cloud_density: real("cloud_density").notNull().default(0),
  precipitation_rate: real("precipitation_rate").notNull().default(0),
  ground_wetness: real("ground_wetness").notNull().default(0),
  grass_density: real("grass_density"),
  grass_type: text("grass_type"),
  grass_health: real("grass_health"),
  grass_dormant: integer("grass_dormant"),
